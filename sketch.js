...
function setup() {
	...
	stone=new Stone(85,603)
	sling=new SlingShot(stone.body,{x:85,y:603})
	ground=new Ground()
	Engine.run(engine);
...
function detectollision(lstone,lmango){
	...
	var distance=dist(stoneBodyPositioon.x,stoneBodyPositioon.y,mangoBodyPosition.y,mangoBodyPosition.x)
